...
kcptun_config_client="/usr/local/kcptun/client_config.json"
...
show_kcptun_for_ss_ssr(){
    ...
    if [ "${kcptun_install_flag}" == "true" ]; then
        ...
        echo "=========================================================="
        echo "Kcptun config for SS/SSR/Phone:" > $kcptun_config_client
        echo "KCP Port    :${set_kcptun_port}" >> $kcptun_config_client
        echo "--crypt ${set_kcptun_method} --key ${set_kcptun_pwd} --mtu ${set_kcptun_mtu} --sndwnd 128 --rcvwnd 1024 --mode ${set_kcptun_mode}${show_kcptun_nocomp}" >> $kcptun_config_client
    fi
    echo
}
